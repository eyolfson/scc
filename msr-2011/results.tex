...
\caption{\label{fig-bugginess-hour}Percentage of buggy commits (bars) and total
  number of commits (circles) versus time-of-day}
\end{figure*}
...
\caption{\label{fig-linux-bugginess-experienced}Percentage of buggy commits
  (bars) and total number of commits (markers) versus time-of-day for
...
with commit bugginess for authors who are inexperienced and experienced. We used
a cutoff of 2 years. This bound separates the total number of commits for each
category in approximately half. The lines respresent the overall
bugginess. Note, we only plot this data for the Linux kernel since it has more
developers and data.
...
\caption{\label{fig-introduction-day}Subsequent bug fixes per commit (bars) and
  total commits (circles) versus day-of-week}
\end{figure*}
...
Our result shows that the day of week of commits vary for different software
projects, implying that the bugginess prediction based on the day of week of
