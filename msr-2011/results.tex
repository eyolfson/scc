...
category in approximately half. The lines respresent the overall bugginess. We
only plot this data for the Linux kernel since it has more developers and data.
