...
Figure~\ref{fig-fix} presents an example of a bug-fixing commit. Commits
...
committers do not often change time zones\footnote{We were able to identify one
...
%However, it is appropriate to characterize authors by their participation in 
%a single project when analyzing the quality of their contributions to that 
%project. 
