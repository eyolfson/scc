...
Listing~\ref{lst-fix} presents an example of a bug-fixing commit. Commits
...
bug lifetime's to be the time from the earliest commit which introduced the bug
...
false positives contribute to precision and recall; Section~\ref{sec-results}
...
and Monday-Friday days of the week.  Many software companies have flexible
hours; however, we expect that developers who are directed to work on a project
solely as their day job would still have the bulk of their commits between those
