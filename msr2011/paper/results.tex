...
\subfigure[{Linux kernel}]{
 ...
 \includegraphics[width=\columnwidth]{../figure/linux-bugginess-hour.pdf}
}
\subfigure[PostgreSQL]{
 \label{fig-postgresql-bugginess-hour}
 \includegraphics[width=\columnwidth]{../figure/postgresql-bugginess-hour.pdf}
}
...
\subfigure[{Linux kernel}]{
 ...
 \includegraphics[width=\columnwidth]{../figure/linux-introductions-hour.pdf}
}
\subfigure[PostgreSQL]{
 \label{fig-postgresql-introduction-hour}
 \includegraphics[width=\columnwidth]{../figure/postgresql-introductions-hour.pdf}
}
...
\begin{figure}[t!hb]
\begin{center}
\includegraphics[width=\columnwidth]{../figure/linux-bugginess-author-class.pdf}
\end{center}
...
\subfigure[{Linux kernel}]{
 ...
 \includegraphics[width=\columnwidth]{../figure/linux-bugginess-experience.pdf}
}
\subfigure[PostgreSQL]{
 \label{fig-postgresql-bugginess-experience}
 \includegraphics[width=\columnwidth]{../figure/postgresql-bugginess-experience.pdf}
}
...
\begin{figure*}[tbh]
\includegraphics[width=\textwidth]{../figure/linux-bugginess-hour-combined.pdf}
\caption{\label{fig-linux-bugginess-hour-combined}Percentage of buggy commits
...
Figure~\ref{fig-linux-bugginess-hour-combined} combines data from
...
\subfigure[{Linux kernel}]{
 ...
 \includegraphics[width=\columnwidth]{../figure/linux-bugginess-day.pdf}
}
\subfigure[PostgreSQL]{
 \label{fig-postgresql-bugginess-day}
 \includegraphics[width=\columnwidth]{../figure/postgresql-bugginess-day.pdf}
}
...
\subfigure[{Linux kernel}]{
 ...
 \includegraphics[width=\columnwidth]{../figure/linux-introductions-day.pdf}
}
\subfigure[PostgreSQL]{
 \label{fig-postgresql-introduction-day}
 \includegraphics[width=\columnwidth]{../figure/postgresql-introductions-day.pdf}
}
...
\subfigure[{Linux kernel}]{
 ...
 \includegraphics[width=\columnwidth]{../figure/linux-bug-lifetime.pdf}
}
\subfigure[PostgreSQL]{
 \label{fig-postgresql-bug-lifetime}
 \includegraphics[width=\columnwidth]{../figure/postgresql-bug-lifetime.pdf}
}
...
kernel 2.15~$\pm$~0.10\%\footnote{We report the margin of error with 95\%
 confidence level.} of the bug-fixing commits (1,226
commits\footnote{Estimated based on the percentage of comment-only commits and
 the total number of bug-fixing commits.}) were on comments only. 
...
purely maintaining the correctness of comments; these numbers do not even
