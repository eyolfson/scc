...
would be considered to be a non-functional commit by the previous study, but not a comment-fixing commit in this paper. 
...
We estimate that about 1,200 and 130 commits (Section~\ref{sec-comment-only}) %estimated from a random sample) 
