...
each project. 
Figures~\ref{fig-linux-introductions-day} and~\ref{fig-postgresql-introductions-day} present the number of bug introductions per day-of-week, while
Figures~\ref{fig-linux-severity-day} and~\ref{fig-postgresql-severity-day} 
present the severity of bugs per day-of-week, and also present the average
sizes of commits.
...
any particular trends, although we found that the average number of lines
per commit on Sunday was surprisingly large for both Linux and Postgres.

%{\bf Finding \fday and Implications:} 
To summarize our results, we found that commits on different days of week have the same level of bugginess, which
