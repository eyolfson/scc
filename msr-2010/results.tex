...
shows that, in general, the more experienced the developers are, the less likely their commits are buggy.
...
\caption{Bug introductions per commit per day}
...
\caption{Severity of changes per day}
...
the margin of error with 95\% confidence level.} of the bug-fixing
