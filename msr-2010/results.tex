...
while developers tend to commit small, non-buggy changes between 9AM
and noon.
...
\caption{Severity of changes (bars) and total commits (circles) versus time-of-day}
...
\caption{Severity of changes (bars) and total commits (circles) versus day-of-week}
