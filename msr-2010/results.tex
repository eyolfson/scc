...
systems to warn the developers of late-night commits to improve software reliability. 
...
\caption{\label{fig-bugginess-hour}The percentage of buggy commits (bars) and total number of commits (circles) versus time-of-day}
...
\caption{\label{fig-introduction-hour}Bug introductions per commit (bars) and total commits (circles) versus time-of-day}
 % caption for the whole figure
\end{figure*}
...
\caption{\label{fig-introduction-day}Number of bug-introducing commits (bars) and total commits (circles) versus day-of-week}
 % caption for the whole figure
\end{figure*}
