...
changed. Finally, we searched the repository %% Jon: specified that we ignore comments here
...
committer classification, we also use a heuristic to identify committers
...
responsibility for the patch to its committer, who would presumably
