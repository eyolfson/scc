...
Our major findings are summarized below ($\S$ denotes in which section the finding and its {\em implications} are discussed):
...
and cause further developer activities to fix them.
