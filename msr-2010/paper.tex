...
\newcommand{\linuxP}{86\%\xspace} %precision for linux
\newcommand{\linuxR}{61\%\xspace} % recall for linux, lower bound
\newcommand{\postP}{84\%\xspace} % precision ofr postgreSQL
\newcommand{\postR}{63\%\xspace} % recall for postgreSQL, lower bound
