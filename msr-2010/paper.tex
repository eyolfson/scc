...
\newcommand{\linuxP}[1]{86.0\%} %precision for linux
\newcommand{\linuxR}[1]{64.8\%} % recall for linux
\newcommand{\postP}[1]{84.0\%} % precision ofr postgreSQL
\newcommand{\postR}[1]{66.4\%} % recall for postgreSQL
\newcommand{\note}[1]{{\bf *** NOTE: {#1} ***}}
