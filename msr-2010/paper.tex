...
\newcommand{\linuxP}{86.0\%\xspace} %precision for linux
\newcommand{\linuxR}{64.8\%\xspace} % recall for linux
\newcommand{\postP}{84.0\%\xspace} % precision ofr postgreSQL
\newcommand{\postR}{66.4\%\xspace} % recall for postgreSQL
\newcommand{\note}[1]{{\bf *** NOTE: {#1} ***}}
