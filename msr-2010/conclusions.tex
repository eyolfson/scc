...
%indicating that the day of week of commits
...
%we 
%Since there
%may be correlations between a patch’s evolution and its code quality,
%we intend to investigate these issues in future work.
